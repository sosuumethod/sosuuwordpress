                  ...
                  <div class="logo-wrapper">
                        <a class="themeum-navbar-brand" href="<?php echo esc_url(site_url()); ?>">
                              <?php
                                  ...
                                  $logotext = get_theme_mod( 'logo_text', 'starter' );
                                  $logotype = get_theme_mod( 'logo_style', 'logoimg' );
                                  switch ($logotype) {
                                    case 'logoimg':
                                        if( !empty($logoimg) ) {?>
                                            <img class="enter-logo img-responsive" src="<?php echo esc_url( $logoimg ); ?>" alt="<?php  esc_html_e( 'Logo', 'starter' ); ?>" title="<?php  esc_html_e( 'Logo', 'starter' ); ?>">
                                        <?php }else{?>
