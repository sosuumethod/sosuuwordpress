	...
	class THMC_Framework
	{
		...
		public function customizer_scripts()
		{
			...
			wp_localize_script( 'thmc-customizer', 'thm_customizer', array(
				...
				'import_success' => esc_html__('Success! Your theme data successfully imported. Page will be reloaded within 2 sec.', 'starter'),
				'import_error' => esc_html__('Error! Your theme data importing failed.', 'starter'),
				'file_error' => esc_html__('Error! Please upload a file.', 'starter')
			) );
		}
...
class THM_Customize
{
	...
	public function import_export_ui( $wp_customize )
	{
		...
		$wp_customize->add_section( 'thm_import_export', array(
			'title'           => esc_html__( 'Import/Export', 'starter' ),
			'description'     => esc_html__( 'Import Export Option Data', 'starter' ),
			'priority'        => 1000,
		) );
...
require_once(get_template_directory() . '/lib/customizer/libs/starterads.php' );
