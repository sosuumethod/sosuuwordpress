...
class Themeum_social_share_Widget extends WP_Widget{
	...
	public function __construct() {
		parent::__construct( 'Themeum_social_share_Widget', esc_html__("Themeum Social Share Widgets",'starter'), array('description' => esc_html__("This Social Share Widgets",'starter')) );
	}
...
*-------------------------------------------------------*/
	...
	public function form( $instance )
	{
	   ...
	   ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e('Title :', 'starter'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'facebook_url' ); ?>"><?php esc_html_e('Facebook URL: ', 'starter'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'twitter_url' ); ?>"><?php esc_html_e('Twitter URL: ', 'starter'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'gplus_url' ); ?>"><?php esc_html_e('Google Plus URL: ', 'starter'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'linkedin_url' ); ?>"><?php esc_html_e('Linkedin URL: ', 'starter'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'rss_url' ); ?>"><?php esc_html_e('RSS URL: ', 'starter'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'pinterest_url' ); ?>"><?php esc_html_e('Pinterest URL: ', 'starter'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'youtube_url' ); ?>"><?php esc_html_e('Youtube URL: ', 'starter'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'instagram_url' ); ?>"><?php esc_html_e('Instagram URL: ', 'starter'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'vimeo_url' ); ?>"><?php esc_html_e('Vimeo URL: ', 'starter'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'dribble_url' ); ?>"><?php esc_html_e('Dribble URL: ', 'starter'); ?></label>
