                    ...
                    <?php while ( have_posts() ) : the_post(); ?>
                        ...
                        <?php get_template_part( 'post-format/content', get_post_format() ); ?>
                            ...
                            <div class="clearfix post-navigation">
                                ...
                                <?php previous_post_link('<span class="previous-post pull-left fa fa-long-arrow-left">%link</span>',esc_html__("Previous",'starter')); ?>
                                </div>

                                <div class="single-next">
                                <?php next_post_link('<span class="next-post pull-right fa fa-long-arrow-right">%link</span>',esc_html__("Next",'starter')); ?>
                                </div>
